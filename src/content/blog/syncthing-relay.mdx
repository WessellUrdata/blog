...
- HK2: `relay://149.104.24.71:22067` (2 MB/s per session, 10 MB/s globally, subject to change) (I severely reduced the bandwidth limit because I'm hitting the monthly bandwidth limit for the VPS, and to funnel traffic to HK1)
