...
<div class="not-prose flex flex-col mx-auto w-full text-center">
  Removed for the time being.
  {/* <WeatherInfo />
  <WeatherCard displayLocation="Hung Hom" API_URL="https://www.hko.gov.hk/PDADATA/locspc/data/gridData/0906_en.xml" /> */}
</div>

Turns out it's broken right now due to my sloppy spaghetti architecture. To be fixed Soon:tm: :relaxed:.
